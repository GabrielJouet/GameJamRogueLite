...
public class Room : MonoBehaviour
{
    ...
    public List<Vector2Int> GetAllNeighbourPlaces()
    {
        ...
        if (_grid.CheckRoomExistence(new Vector2Int(_position.x, _position.y + 1)) && _upDoor != null)
            buffer.Add(new Vector2Int(_position.x, _position.y + 1));

        if (_grid.CheckRoomExistence(new Vector2Int(_position.x - 1, _position.y)) && _leftDoor != null)
            buffer.Add(new Vector2Int(_position.x - 1, _position.y));
    ...
    public List<Vector2Int> GetAllAvailableNeighbourPlaces()
    {
        List<Vector2Int> buffer = new List<Vector2Int>();
